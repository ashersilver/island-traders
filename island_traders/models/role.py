...
ROLES: dict[str, Role] = {
    "Farmer": Role(
        ...
        description="Feeds the archipelago with raw staples and packaged Food — output varies by season.",
    ),
    "Miner": Role(
        name="Miner",
    ...
    "Transporter": Role(
        ...
        produces=(ResourceType.FREIGHT, ResourceType.PASSENGER_SEATS),
    ...
    "Doctor": Role(
        ...
        produces=(
            ...
            ResourceType.LABORATORY_TESTS,
        ),
        needs=(ResourceType.EXPERTISE, ResourceType.REAGENTS),
        description=(
            "Provides medical supplies, vaccines and laboratory tests, "
